...
string refactorFirstSentence = StringProcessing.RefactorFirstSentence(text);
...
Console.WriteLine("RefactoredSentence: {0}",refactorFirstSentence);


User client1 = new User(12, "Ahmed", "Ali", "ahmedali@gmail.com");

Flight flight1 = new Flight("New York", "London", TimeSpan.FromHours(7));


DateTime departureDateTime = DateTime.Parse("2024-01-01 10:30");

TimeZoneInfo departureTimeZone = TimeZoneInfo.FindSystemTimeZoneById("Eastern Standard Time");

DateTimeOffset departureTimeOffset = new DateTimeOffset(departureDateTime, departureTimeZone.GetUtcOffset(departureDateTime));

BookTheFlight bokedFlight = new BookTheFlight(client1, flight1, departureTimeOffset);

Console.OutputEncoding = Encoding.UTF8;

bokedFlight.ShowData();
